...
static const CodexBarProviderDescriptor providers[] = {
    ...
    {"openai", "OpenAI", "openai", "openai-api", A | P, FALSE, "https://platform.openai.com/usage", "https://status.openai.com", CODEXBAR_NATIVE_UNAVAILABLE},
    ...
    {"claude", "Claude", "claude", NULL, A | P | W | C | O, FALSE, "https://console.anthropic.com/settings/billing", "https://status.claude.com/", CODEXBAR_NATIVE_UNAVAILABLE},
    ...
    {"kimi", "Kimi", "kimi", "kimi-ai", A | P | W, FALSE, "https://www.kimi.com/code/console", NULL, CODEXBAR_NATIVE_UNAVAILABLE},
    ...
    {"kimik2", "Kimi K2 (unofficial)", "kimik2", "kimi-k2,kimiK2", A | P, FALSE, "https://kimrel.com/my-credits", NULL, CODEXBAR_NATIVE_UNAVAILABLE},
    ...
    {"llmproxy", "LLM Proxy", "llmproxy", "llm-api-key-proxy,llm-proxy", A | P, FALSE, NULL, NULL, CODEXBAR_NATIVE_UNAVAILABLE},
    ...
    {"clawrouter", "ClawRouter", "clawrouter", "claw-router", A | P, FALSE, "https://clawrouter.openclaw.ai/dashboard/access", NULL, CODEXBAR_NATIVE_UNAVAILABLE},
