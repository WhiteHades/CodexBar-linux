...
the native engine currently owns Codex, Codebuff API-key usage, Kimi API-key usage, Kimi K2, OpenRouter, ClawRouter,
LLM Proxy, DeepSeek, Moonshot, ElevenLabs, Crof, Venice, and ZenMux. configure
